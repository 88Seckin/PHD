    ...
    static class Program
    {
        ...
        string[] names = new string[3];
            ...
            */
            ...
            using (var csvReader = new CsvReader(new StreamReader(System.IO.File.OpenRead(@"C:\Users\DA00625\Desktop\this.csv")), true))
            {
        ...
        last = a;
            ...
            System.IO.File.AppendAllText(@"C:\Users\DA00625\Desktop\thisis.txt", time.ToString());
